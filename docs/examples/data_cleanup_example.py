...
def main():
    ...
    cleanup_rules = [
        ...
        CleanupRule(
            ...
            fix_missing=lambda record: f"{record['first_name'].lower()}.{record['last_name'].lower()}@unknown.com"
    ...
    print(
        f"  Format standardizations: {cleaned_data.stats.get('format_standardizations', 0)}"
    )

"""Advanced abbreviation examples for the Transmog package.

This module demonstrates more complex and advanced abbreviation strategies
and customization options for table and field names.
"""
...
def main():
    ...
    output_dir = os.path.join(
        os.path.dirname(__file__), "..", "data", "output", "abbreviation"
    )

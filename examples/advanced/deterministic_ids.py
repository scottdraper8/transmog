...
def main():
    ...
    basic_deterministic_processor = tm.Processor.with_deterministic_ids(
        id_fields={
    ...
    detailed_processor = tm.Processor.with_deterministic_ids(id_fields=id_mapping)
    ...
    custom_config = tm.TransmogConfig.default().with_metadata(
        deterministic_id_generator=custom_id_generator
    )
    ...
    processor = tm.Processor.with_deterministic_ids(id_fields=id_mapping)

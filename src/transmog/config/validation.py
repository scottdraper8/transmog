...
def validate_config(config_dict: dict[str, Any]) -> None:
    ...
    id_field = config_dict.get("id_field", "__transmog_id")
    parent_field = config_dict.get("parent_field", "__parent_transmog_id")
    time_field = config_dict.get("time_field", "__transmog_datetime")

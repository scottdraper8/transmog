...
class TransmogConfig:
    ...
    def with_extraction(self, **kwargs) -> "TransmogConfig":
        ...
        This is a convenience alias for with_metadata() focusing on extraction settings.
    ...
    def with_validation(self, **kwargs) -> "TransmogConfig":
        """
        Update validation settings.

        This is a convenience alias for with_processing() focusing on validation settings.

...
class TestExceptionTypes:
    ...
    def test_missing_dependency_error_with_package(self):
        """Test MissingDependencyError preserves package information."""
        error = MissingDependencyError("Dependency required", package="pyarrow")
        assert error.package == "pyarrow"
        assert str(error) == "Dependency required"

    def test_missing_dependency_error_without_package(self):
        """Test MissingDependencyError works without package name."""
        error = MissingDependencyError("Optional dependency missing")
        assert error.package is None
        assert str(error) == "Optional dependency missing"

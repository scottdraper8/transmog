...
class TestCsvWriter(AbstractWriterTest):
    ...
    def test_header_option(self, writer, batch_data, tmp_path):
        ...
        with open(output_with_header, "r", newline="") as f:
            reader = csv.reader(f)
            rows = list(reader)
        ...
        with open(output_without_header, "r", newline="") as f:
            reader = csv.reader(f)
            rows = list(reader)
    ...
    def test_quoting_options(self, tmp_path):
        ...
        with open(outputs["minimal"], "r") as f:
            content = f.read()
    ...
    def test_escapechar_option(self, tmp_path):
        ...
        test_data = [
            ...
            {"id": 3, "name": "Backslash \\", "description": "Has a backslash"},
        ]
        ...
        with open(output_path, "r", newline="") as f:
            ...
            # Verify the backslash is preserved
            assert rows[3][name_index] == "Backslash \\"

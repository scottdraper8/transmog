...
class TestWriterInterface:
    ...
    def test_writers_implement_interface(self, registered_writers):
        ...
        for format_name, writer_class in registered_writers.items():
            ...
            assert callable(getattr(writer_class, "format_name")), (
            ...
            assert callable(getattr(writer_class, "is_available")), (
            ...
            assert callable(getattr(writer, "write_table")), (
            ...
            assert callable(getattr(writer, "write_all_tables")), (

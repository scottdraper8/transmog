...
import os
import pytest
from typing import Any, Dict, List, Type, Optional, BinaryIO, Union

# Import reader-related classes
from transmog.io.readers.csv import CSVReader
from transmog.io.readers.json import JsonReader, JsonlReader
        ...
        for format_name, reader_class in available_readers.items():
            ...
            try:
                ...
                if format_name == "csv":
                    ...
                    assert callable(getattr(reader, "read_all")), (
                    ...
                    assert callable(getattr(reader, "read_file")), (
                ...
                if hasattr(reader, "read_stream"):
                    assert callable(getattr(reader, "read_stream")), (
                        f"{reader_class.__name__}.read_stream must be callable"
                    )
                elif hasattr(reader, "read_in_chunks"):
                    assert callable(getattr(reader, "read_in_chunks")), (
